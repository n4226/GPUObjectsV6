...
PipelineCreator::~PipelineCreator()
{
    ...
    device.destroyPipelineLayout(terrianPipelineLayout);
    device.destroyPipeline(trianglePipeline);
    device.destroyPipeline(terrianPipeline);

    device.destroyDescriptorSetLayout(triangleDescriptorSetLayout);
    device.destroyDescriptorSetLayout(terrianDescriptorSetLayout);
}
...
void PipelineCreator::createTerrainPipeline()
{
    // DescriptorSetLayout
